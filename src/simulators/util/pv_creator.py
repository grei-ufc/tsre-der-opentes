...
class PVGenerator:
    ...
    _solar_cache: typing.ClassVar[dict] = {}
    ...
    def __init__(
        ...
        if self.FILE_CSV not in PVGenerator._solar_cache:
            try:
                ...
                raise FileNotFoundError(f"Error: Dataset file {self.SOLAR_STATION_FILE} not found.") from err
...
def PVCreator(QtdPVs,
    ...
    try:
        ...
        allbuses_mapping["bus"].str.split(".").str[0]
